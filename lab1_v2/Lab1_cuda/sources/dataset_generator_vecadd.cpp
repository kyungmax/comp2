...
int main() {
  base_dir = gpuTKPath_join(gpuTKDirectory_current(), "VectorAdd", "Dataset");
  ...
  create_dataset(6, 14000);
  create_dataset(7, 25365);
  create_dataset(8, 48000);
  create_dataset(9, 96000);
  create_dataset(10, 192000);
  return 0;
}
