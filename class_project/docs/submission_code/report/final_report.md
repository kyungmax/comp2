...
On the full GloVe query set, multi-entry upper-layer descent improves hard-query recall substantially. The gain has a clear knee around `entry_count=32` and mostly saturates around `entry_count=64`; larger entry counts add only small extra recall for much higher cost.
...
- Candidate scope:
  - `upper_window=3`
  - `entry_count in {1, 16, 32, 64, 128, 256}`
- GPU:
  - NVIDIA RTX A6000
  - Driver `565.57.01`
...
| 256 | 0.2657 | 0.2845 | 0.2914 | 0.2990 |
...
| 256 | +0.1102 | +0.0972 | +0.0631 | +0.0311 |
...
| 256 | 0.5272 | 0.6195 | 0.6977 | 0.7641 |
...
| 256 | 507.267 | 96.023 | 50.727 | 1.14906 |
...
| 256 | 16 | 0.5272 | 0.2657 | +0.1102 | 620.184 | +474.902 |
| 256 | 32 | 0.6195 | 0.2845 | +0.0972 | 712.789 | +460.855 |
| 256 | 64 | 0.6977 | 0.2914 | +0.0631 | 788.684 | +405.528 |
| 256 | 128 | 0.7641 | 0.2990 | +0.0311 | 1069.209 | +374.354 |

`entry_count=32` has the best recall-latency balance. `entry_count=64` gives slightly higher hard-query recall at a moderate extra cost. Beyond that point, the additional recall gain is small relative to the added latency.
...
3. The improvement saturates. `entry_count=32` captures most of the benefit, and `entry_count=64` is a robust sweet spot.
